...
export function RoadmapGenerator({ onRoadmapGenerated, setIsLoading, isLoading, initialSkill }: RoadmapGeneratorProps) {
  ...
  return (
    <Card className="max-w-3xl mx-auto border-2 border-primary/20 shadow-xl">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-3xl font-extrabold tracking-tight">Create Your Learning Path</CardTitle>
        <CardDescription className="text-lg">Tell us your goals, and we'll generate a personalized roadmap for you.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-base">What do you want to learn?</FormLabel>
                  <FormControl>
                    <Input placeholder="e.g., Advanced React, Python for Data Science" {...field} />
                  </FormControl>
                  <FormDescription>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                render={({ field }) => (
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectItem value="hands-on coding">Hands-on Coding</SelectItem>
