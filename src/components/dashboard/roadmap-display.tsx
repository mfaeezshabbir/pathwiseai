      ...
      <AlertDialogContent>
        ...
        <ScrollArea className="h-60">
          <div className="p-4 space-y-2">
            ...
            {isLoading && (
              <p className="text-muted-foreground text-center">Generating...</p>
            )}
          </div>
        </ScrollArea>
        <AlertDialogFooter>
                        ...
                        {(unit.resources || []).map((resource, rIndex) => (
                          ...
                          >
                            <Checkbox
                              ...
                              onCheckedChange={() =>
                                handleToggleResource(mIndex, uIndex, rIndex)
                              }
                              className="mt-1"
                            />
                            <label
                            ...
                            >
                              ...
                              {resource.url && (
                                <a
                                  ...
                                  className="text-xs text-primary hover:underline break-all ml-6"
                                >
                                  {resource.url}
                                </a>
                              )}
