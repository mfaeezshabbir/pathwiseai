    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            By using our application, PathWise AI (the "Service"), you agree to
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            ...
            are and will remain the exclusive property of PathWise AI and its
            licensors.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            ...
            PathWise AI makes no representations or warranties of any kind,
