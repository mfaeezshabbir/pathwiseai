...
export const suggestRoadmapTool = ai.defineTool(
  {
    ...
    description: 'Use this tool to suggest that the user generate a learning roadmap for a specific skill or technology. This should be used when a user asks for learning recommendations.',
